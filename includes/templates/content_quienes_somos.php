<div class="container ">
    <div class="well">
        ...
        <p>Nuestros productos llegan a miles de usuarios en todo el mundo a través de una extensa red de soporte técnico-comercial.</p>
        <p></p>
        <div class="row divider text-center">
            <img class="img img-polaroid img-circle center" src="http://www.anasac.cl/anasac/rps_anasac_v57/OpenSite/Anasac/Empresa/Qui%C3%A9nes%20Somos/Corpo%20Quienesomos.jpg" />
        </div>
    </div><!-- /.row -->
</div><!-- /.container -->
